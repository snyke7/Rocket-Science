...
public class RenderDefenseLaser extends Render
{
    public RenderDefenseLaser()
    {
    }
     ...
     */
    public void doRenderLightningBolt(EntityDefenseLaser par1EntityLightningBolt, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            for (int k = 0; k < 3; k++)
            {
                ...
                for (int j1 = l; j1 >= i1; j1--)
                {
                    ...
                    float f = 0.5F;
                    tessellator.setColorRGBA_F(0.9F, 0.1F, 0.1F, 0.3F);
    ...
    {
        doRenderLightningBolt((EntityDefenseLaser)par1Entity, par2, par4, par6, par8, par9);
    }
}
